package Page_UI.nopCommerce;

public class RegisterPageUI {
	public static final String GENDER_MALE_RADIO = "//input[@id='gender-male']";
	public static final String FIRSTNAME_TEXBOX = "//input[@id='FirstName']";
	...
	public static final String REGISTERED__SUCCESS_MESSAGE = "//div[@class='result' and text()= 'Your registration completed']";
